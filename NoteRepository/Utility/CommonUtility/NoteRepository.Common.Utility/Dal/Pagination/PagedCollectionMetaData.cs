...
{
    ///<summary>
    /// Non-enumerable version of the PagedCollection class.
    ///</summary>
    public class PagedCollectionMetaData : IPagedCollection
    {
        /// <summary>
        /// Protected constructor that allows for instantiation without passing in a separate list.
        /// </summary>
        protected PagedCollectionMetaData()
        {
        }
        ...
        /// Non-enumerable version of the PagedCollection class.
        ///</summary>
        ///<param name="pagedList">A PagedCollection (likely enumerable) to copy meta data from.</param>
        public PagedCollectionMetaData(IPagedCollection pagedList)
        {
        ...
        #endregion IPagedCollection Members
    }
}