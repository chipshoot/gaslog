...
namespace NoteRepository.Common.Utility.Dal.Pagination
{
    ...
    /// <seealso cref = "List{T}" />
    [Serializable]
    public abstract class PagedCollectionBase<T> : PagedCollectionMetaData, IPagedCollection<T>
    {
        ...
        /// </summary>
        protected ICollection<T> Subset { get { return _subset; } }

        /// <summary>
        /// Parameterless constructor.
        /// </summary>
        protected internal PagedCollectionBase()
        {
        }

        /// <summary>
        /// 	Initializes a new instance of a type deriving from <see cref = "PagedCollectionBase{T}" /> and sets properties needed to calculate position and size data on the subset and superset.
        /// </summary>
        ...
        protected internal PagedCollectionBase(int pageNumber, int pageSize, int totalItemCount)
        {
        ...
        public IPagedCollection GetMetaData()
        {
            return new PagedCollectionMetaData(this);
        }

        #endregion IPagedCollection<T> Members
    }
}