...
namespace NoteRepository.Common.Utility.Misc
{
    ...
    /// </summary>
    public static class SqlReaderHelperExtensions
    {
        /// <summary>
        ...
        public static T GetValue<T>(this IDataRecord theReader, string theColumnName)
        {
            ...
            if (DBNull.Value != theValue)
            {
                ...
                {
                    var orgValType = theValue.GetType();
                    if (orgValType == theValueType)
                    {
                        return (T)theValue;
                    }
                    ...
                    return (T) TypeDescriptor.GetConverter(orgValType).ConvertTo(theValue, theValueType);
                }
