...
{
    /// <summary>
    /// A warp interface of Log4Net.ILog
    /// </summary>
    public interface ILogService
    {
        ...
        /// when the class is loaded. Using a <c>private static read-only</c>
        ...
        /// The message is formatted using the <c>String.Format</c> method. See
        /// <see cref="String.Format(string, object[])"/> for details of the syntax
